...
export default function HeroSection() {
  ...
  return (
    <div className='relative '>
      <FloatingOrb baseSize={0.06} speed={0.5} />
      <FloatingOrb baseSize={0.08} speed={1.2} />
      <FloatingOrb baseSize={0.05} speed={0.5} />
      <FloatingOrb baseSize={0.04} speed={0.8} />
      <FloatingOrb baseSize={0.08} speed={1.2} />
      <FloatingOrb baseSize={0.07} speed={0.7} />

      <div className="relative w-full max-w-[707px] mx-auto h-[100vh] overflow-hidden ">
